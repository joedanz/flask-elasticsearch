g.books = [
    ...
    ["Leaves of Grass","http://d2yzl2mysmkr1m.cloudfront.net/pg1322.txt"],
    ["Dracula","http://d2yzl2mysmkr1m.cloudfront.net/pg345.txt"],
    ["Les Miserables","http://d2yzl2mysmkr1m.cloudfront.net/pg135.txt"],
    ["Emma","http://d2yzl2mysmkr1m.cloudfront.net/pg158.txt"],
    ["Steam, Its Generation and Use","http://d2yzl2mysmkr1m.cloudfront.net/pg22657.txt"],
    ["Beowulf","http://d2yzl2mysmkr1m.cloudfront.net/pg16328.txt"],
    ["Dubliners","http://d2yzl2mysmkr1m.cloudfront.net/pg2814.txt"],
    ["Jane Eyre: An Autobiography","http://d2yzl2mysmkr1m.cloudfront.net/pg1260.txt"],
    ["The Romance of Lust","http://d2yzl2mysmkr1m.cloudfront.net/pg30254.txt"],
    ["The Divine Comedy","http://d2yzl2mysmkr1m.cloudfront.net/pg8800.txt"],
]
